...
SRC_FILES	=	minishell.c \
				...
				parser/parser.c parser/init.c parser/cmd.c parser/delete.c parser/redir.c parser/utils.c parser/path.c parser/file.c \
				exec/execute.c exec/process.c exec/wait.c exec/fd.c \
				...
				builtins/ms_cd/ms_cd.c builtins/ms_cd/navigate_1.c builtins/ms_cd/navigate_2.c builtins/ms_cd/utils.c builtins/ms_cd/error.c \
				clean/clean.c
